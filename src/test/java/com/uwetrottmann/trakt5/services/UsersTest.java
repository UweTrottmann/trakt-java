...
public class UsersTest extends BaseTestCase {
    ...
    public void test_lists() throws OAuthUnauthorizedException {
        List<com.uwetrottmann.trakt5.entities.List> lists = getTrakt().users().lists(Username.ME);
        for (com.uwetrottmann.trakt5.entities.List list : lists) {
    ...
    public void test_createList() throws OAuthUnauthorizedException {
        com.uwetrottmann.trakt5.entities.List list = new com.uwetrottmann.trakt5.entities.List();
        ...
        // create list...
        com.uwetrottmann.trakt5.entities.List createdList = getTrakt().users().createList(Username.ME, list);
    ...
    public void test_updateList() throws OAuthUnauthorizedException {
        ...
        // create list...
        com.uwetrottmann.trakt5.entities.List updatedList = getTrakt().users().updateList(Username.ME, String.valueOf(
