...
public class MovieService extends TraktApiService {
    ...
    /**
     * Returns all comments (shouts and reviews) for a movie. Most recent
    ...
    public static final class ScrobbleBuilder extends TraktApiBuilder<Response> {
        ...
        protected void performValidation() {
            assert hasPostParameter(POST_IMDB_ID)
                    || hasPostParameter(POST_TMDB_ID)
    ...
    public static final class SeenBuilder extends TraktApiBuilder<Void> {
        ...
        protected void preFireCallback() {
            ...
            postParameter(POST_MOVIES, movieList);
        }
    }
    ...
    public static final class SummaryBuilder extends TraktApiBuilder<Movie> {
        private static final String URI = "/movie/summary.json/" + FIELD_API_KEY + "/"
                + FIELD_QUERY;
    ...
    public static final class ShoutsBuilder extends TraktApiBuilder<List<Comment>> {
        private static final String URI = "/movie/comments.json/" + FIELD_API_KEY + "/"
                + FIELD_TITLE;
        ...
        /**
         * The slug (i.e. the-social-network-2010) or IMDB ID. You can get a
         * movie's slug by browsing the website and looking at the URL when on a
         * movie summary page.
         * 
         * @param slugOrImdbId Value.
         * @return Builder instance.
         */
        public ShoutsBuilder title(String slugOrImdbId) {
            field(FIELD_TITLE, slugOrImdbId);
            return this;
        }
