...
public interface ActivityService {
    ...
    /**
     * Get a list of all activity for your friends. The most recent 100 activities are returned for all types and
     * actions. You can customize the activity stream with only the types and actions you need.
     *
     * @param types   Send a comma delimited list of types. For supported types see <a
     *                href="http://trakt.tv/api-docs/activity-friends">trakt</a>.
